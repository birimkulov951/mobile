...
class TransferAbroadResultTimeOut extends StatelessWidget {
  final VoidCallback onPopBack;

  const TransferAbroadResultTimeOut({
    Key? key,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: SvgPicture.asset(Assets.timeOut),
            ),
            Text(
              locale.getText('time_out'),
            ...
            Padding(
              ...
              child: Text(
                locale.getText('long_time_on_screen'),
            ...
            ItemContainer(
              ...
              child: Column(
                children: [
                  SizedBox(height: 24),
                  RoundedButton(
                    key: const Key(WidgetIds.transferAbroadTimeOut),
                    onPressed: onPopBack,
