...
import 'package:mobile_ultra/utils/calendar/src/customization/calendar_builders.dart';
import 'package:mobile_ultra/utils/calendar/src/customization/calendar_style.dart';
import 'package:mobile_ultra/utils/calendar/src/customization/days_of_week_style.dart';
import 'package:mobile_ultra/utils/calendar/src/customization/header_style.dart';
import 'package:mobile_ultra/utils/calendar/src/shared/utils.dart';
import 'package:mobile_ultra/utils/calendar/src/table_calendar_base.dart';
import 'package:mobile_ultra/utils/calendar/src/widgets/calendar_header.dart';
import 'package:mobile_ultra/utils/calendar/src/widgets/cell_content.dart';
...
class _TableCalendarState<T> extends State<TableCalendar<T>> {
  ...
  late final ValueNotifier<DateTime> _focusedDay =
      ValueNotifier(widget.focusedDay);

  late RangeSelectionMode _rangeSelectionMode = widget.rangeSelectionMode;
  ...
  void _swipeCalendarFormat(SwipeDirection direction) {
    if (widget.onFormatChanged != null) {
      ...
      widget.onFormatChanged?.call(formats[id]);
    }
  }
    ...
    if (_isRangeSelectionOn && widget.onRangeSelected != null) {
      if (_firstSelectedDay == null) {
        ...
        widget.onRangeSelected
            ?.call(_firstSelectedDay!, null, _focusedDay.value);
      } else {
        if (day.isAfter(_firstSelectedDay!)) {
          widget.onRangeSelected
              ?.call(_firstSelectedDay!, day, _focusedDay.value);
          _firstSelectedDay = null;
        } else if (day.isBefore(_firstSelectedDay!)) {
          widget.onRangeSelected
              ?.call(day, _firstSelectedDay, _focusedDay.value);
          _firstSelectedDay = null;
        }
      }
    } else {
  ...
  void _onDayLongPressed(DateTime day) {
    ...
    if (widget.onDayLongPressed != null) {
      _updateFocusOnTap(day);
      return widget.onDayLongPressed?.call(day, _focusedDay.value);
    }
  ...
  bool _isWithinRange(DateTime day, DateTime? start, DateTime? end) {
    ...
    /// В isSameDay происходит проверка на null
