...
import 'package:mobile_ultra/utils/calendar/src/widgets/calendar_core.dart';
...
class _TableCalendarBaseState extends State<TableCalendarBase>
  ...
  late final rowCount = _getRowCount(widget.calendarFormat, _focusedDay);

  late ValueNotifier<double> _pageHeight =
      ValueNotifier(_getPageHeight(rowCount));
  late PageController _pageController =
      PageController(initialPage: initialPage);
  late DateTime _focusedDay = widget.focusedDay;
  late final initialPage = _calculateFocusedPage(
      widget.calendarFormat, widget.firstDay, _focusedDay);
  late int _previousIndex = initialPage;
  late bool _pageCallbackDisabled = false;
  ...
  double _getPageHeight(int rowCount) {
    final dowHeight = widget.dowVisible ? (widget.dowHeight ?? 0) : 0.0;
