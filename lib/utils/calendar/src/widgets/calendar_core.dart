...
import 'package:mobile_ultra/utils/calendar/src/widgets/calendar_page.dart';
...
class CalendarCore extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PageView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final actualDowHeight = dowVisible ? (dowHeight ?? 0) : 0.0;
  ...
  DateTime _getFocusedDay(
    ...
    final pageDif =
        previousIndex == null ? pageIndex : pageIndex - previousIndex!;
    DateTime day;
