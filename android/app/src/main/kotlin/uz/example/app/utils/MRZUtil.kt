...
object MRZUtil {
    ...
    private const val PASSPORT_LINE_1 = "[P]{1}[A-Z<]{1}[A-Z<]{3}[A-Z0-9<]{39}$"
    private const val PASSPORT_LINE_2 = "[A-Z0-9<]{9}[0-9]{1}[A-Z<]{3}[0-9]{6}[0-9]{1}[FM<]{1}[0-9]{6}[0-9]{1}[A-Z0-9<]{14}[0-9<]{1}[0-9]{1}$"
    ...
    private fun replaceNumberWithAlfa(str: String): String {
        var str = str
    ...
    private fun replaceAlfaWithNumber(str: String): String {
        var str = str
