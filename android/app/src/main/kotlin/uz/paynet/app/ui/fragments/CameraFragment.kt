package uz.paynet.app.ui.fragments
...
abstract class CameraFragment : androidx.fragment.app.Fragment(), ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private fun getFingerSpacing(event: MotionEvent): Float {
        ...
        return sqrt(x = (x * x + y * y).toDouble()).toFloat()
    }
    ...
    private fun showErrorCameraPermissionDenied() {
    ...
    fun getRotation(context: Context, lensPosition: LensPosition = LensPosition.Back): Int {
        val facingCamera = when (lensPosition) {
            LensPosition.Front -> {
    ...
    companion object {
        ...
        private const val KEY_CURRENT_ZOOM_PROGRESS = "KEY_CURRENT_ZOOM_PROGRESS"
        private const val REQUEST_PERMISSIONS = 410
